...
import { BALANS_WAREHOUSES, COUNTERPARTY_KINDS } from '@/features/balans/balansData'
...
export default function BalansFilterModal({ open, onOpenChange, filters, onApply }) {
    ...
    >
      <DialogContent className="p-5 sm:max-w-[520px]">
        <DialogHeader className="flex flex-row items-center justify-between pb-1">
          ...
          <button
            type="button"
            onClick={() => setDraft(EMPTY_BALANS_FILTERS)}
        ...
        <div className="grid gap-4 py-1">
          <div>
            <Label className={labelCls}>Sana (holatga)</Label>
          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <div>
              ...
              <div className="flex flex-col gap-1.5 pt-1">
                {[
                  ['onlyNegative', 'Faqat manfiy qoldiqlar'],
                  ['hideZero', 'Nol qoldiqlarni yashirish'],
                  ['showArchived', "Arxiv yozuvlarni ko'rsatish"],
                ].map(([key, label]) => (
