...
import { EXPENSE_AUTHORS, EXPENSE_KASSAS, EXPENSE_TYPES } from '@/features/expenses/expensesMockData'
...
export default function ExpenseFilterModal({ open, onOpenChange, filters, onApply }) {
        ...
        <div className="grid gap-4 py-1">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <NumberInput decimals={false} placeholder="0" value={draft.minUzs} onChange={(e) => set('minUzs', e.target.value)} className={inputCls} />
                <NumberInput decimals={false} placeholder="10 000 000" value={draft.maxUzs} onChange={(e) => set('maxUzs', e.target.value)} className={inputCls} />
              </div>
            </div>
          </div>
