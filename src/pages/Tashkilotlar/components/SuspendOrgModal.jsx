    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-5 sm:max-w-[520px]">
        ...
        <div className="rounded-lg bg-[#FEECEC] px-4 py-3 text-[13px] leading-[19px] text-[#DC2626] dark:bg-[#DC2626]/15">
          <p>To‘xtatilgandan so‘ng tashkilot foydalanuvchilari tizimga kira olmaydi.</p>
          <p className="mt-1.5">
            Ma’lumotlar o‘chmaydi: filiallar, savdolar va hujjatlar saqlanib qoladi. Tashkilot
            «To‘xtatilgan» holatiga o‘tadi va istalgan vaqtda qayta faollashtiriladi.
          </p>
        </div>
        ...
        <div className="rounded-lg bg-[#F5F5F5] px-4 py-3 text-[13px] dark:bg-white/5">
          {[
            ['Tashkilot', org.name],
            ['INN', org.inn],
            ['Filiallar', `${org.stats.filiallar} ta`],
            ['Foydalanuvchilar', `${org.stats.foydalanuvchilar} ta`],
          ].map(([k, v]) => (
        ...
        <div>
          ...
          />
          <p className="mt-1.5 text-[12px] text-[#737373] dark:text-muted-foreground">
            Majburiy. Sabab audit jurnaliga yoziladi.
          </p>
        </div>
